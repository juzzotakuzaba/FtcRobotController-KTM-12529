...
@Autonomous(name = "BlueLEft", group = "AutoOP")
public class BlueLeft extends Robot {
    OpenCvCamera webcam;
    ...
    public void runOpMode() {
        ...
        waitForStart();
        {
            ...
            if (ShElementPosition == 1 && check) {
                ...
                setMotorsPower(-0.4 * koeff, 0 * koeff, -0.4 * koeff, 0 * koeff);
                sleep(500);
                ...
                for (int i = 0; i < 2; i = i + 1) {
                    ...
                    s3Rotation.setPosition(0);
                    sleep(560);
                    setMotorsPower(0.1 * koeff, -0.1 * koeff, -0.7 * koeff, 0.7 * koeff);
                    sleep(700);
                    m5Lift.setPower(0);
                    ...
                    m8Val.setPower(-1);
                    setMotorsPower(0.5 * koeff, -0.5 * koeff, -0.8 * koeff, 0.8 * koeff);
                    sleep(700);
                    setMotorsPower(0, 0, 0, 0);
                    setMotorsPower(0.2 * koeff, -0.2 * koeff, -0.45 * koeff, 0.45 * koeff);
                    sleep(1100);
                    setMotorsPower(0, 0, 0, 0);
                    sleep(1000);
                    ...
                    boolean flag = false;
                    if (distancion.getDistance(DistanceUnit.CM) < 120) {
                        flag = true;
                    }
                    timing.reset();
                    while (flag && distancion.getDistance(DistanceUnit.CM) < 70) {
                        telemetry.addData("millis", timing.milliseconds());
                        telemetry.update();
                        setMotorsPower(-0.5 * koeff, 0.5 * koeff, 0.1 * koeff, -0.1 * koeff);
                    }
                    setMotorsPower(0, 0, 0, 0);
                    sleep(300);
                    ...
                    setMotorsPower(-0.5 * koeff, 0.5 * koeff, 0.2 * koeff, -0.2 * koeff);
                    sleep(1000);
                    setMotorsPower(0, 0, 0, 0);
                    m6Intake.setPower(0);
                    m8Val.setPower(0);
                    setMotorsPower(0 * koeff, 0.33 * koeff, 0.33 * koeff, 0 * koeff);
                    sleep(950);
                    m5Lift.setPower(-1);
                    s3Rotation.setPosition(0.33);
                    setMotorsPower(0 * koeff, 0.33 * koeff, 0.33 * koeff, 0 * koeff);
            ...
            sleep(600);
            setMotorsPower(0, 0, 0, 0);
            setMotorsPower(0.9 * koeff, -0.9 * koeff, -0.9 * koeff, 0.9 * koeff);
            sleep(700);
            m5Lift.setPower(0);
            sleep(500);
            setMotorsPower(0 * koeff, 0 * koeff, 0 * koeff, 0 * koeff);
